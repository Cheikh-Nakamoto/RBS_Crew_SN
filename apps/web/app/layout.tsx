...
const djGross = localFont({
  src: '../public/fonts/dj_gross/DJGROSS.woff2', // Chemin relatif vers le dossier public
  variable: '--font-dj-gross',
  display: 'swap',
});
...
export const metadata: Metadata = {
  ...
  keywords: ['graffiti', 'art urbain', 'Dakar', 'Sénégal', 'RBS Crew'],
  openGraph: {
    type: 'website',
    locale: 'fr_SN',
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html
      lang="fr"
      className={`${archivoBlack.variable} ${inter.variable} ${djGross.variable} h-full antialiased`}
    >
