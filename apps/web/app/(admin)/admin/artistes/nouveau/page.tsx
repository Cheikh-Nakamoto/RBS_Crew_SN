...
export default function NouveauArtistesPage() {
  return <TranslatableEntityForm mode="create" backHref="/admin/artistes" entityLabel="artiste" showImage={true} showGallery={true} showMeta={false} onCreate={createArtistes} />;
}
